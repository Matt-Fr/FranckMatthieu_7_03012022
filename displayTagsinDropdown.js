...
export class DisplayTagsInDropdown {
  constructor() {
    ...
    this.appareilList = document.querySelector(".appareil-list");
    this.ustensilList = document.querySelector(".ustensiles-list");
